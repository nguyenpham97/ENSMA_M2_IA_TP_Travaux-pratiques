 ...
 * </p>
 * <ul>
 *   <li>{@link robotnxt.impl.TurnLeftImpl#getAngle <em>Angle</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TurnLeftImpl extends MovementImpl implements TurnLeft {
	...
	protected EClass eStaticClass() {
		return RobotnxtPackage.Literals.TURN_LEFT;
	}
	...
	public void setAngle(int newAngle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RobotnxtPackage.TURN_LEFT__ANGLE, oldAngle, angle));
	}
