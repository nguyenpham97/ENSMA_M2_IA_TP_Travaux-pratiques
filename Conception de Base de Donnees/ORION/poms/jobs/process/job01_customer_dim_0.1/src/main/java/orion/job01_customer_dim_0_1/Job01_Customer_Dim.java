...
package orion.job01_customer_dim_0_1;
...
public class Job01_Customer_Dim implements TalendJob {
	...
	public static class customer_dimStruct implements routines.system.IPersistableRow<customer_dimStruct> {
		final static byte[] commonByteArrayLock_ORION_Job01_Customer_Dim = new byte[0];
		static byte[] commonByteArray_ORION_Job01_Customer_Dim = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ORION_Job01_Customer_Dim.length) {
					if (length < 1024 && commonByteArray_ORION_Job01_Customer_Dim.length == 0) {
						commonByteArray_ORION_Job01_Customer_Dim = new byte[1024];
					} else {
						commonByteArray_ORION_Job01_Customer_Dim = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ORION_Job01_Customer_Dim, 0, length);
				strReturn = new String(commonByteArray_ORION_Job01_Customer_Dim, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ORION_Job01_Customer_Dim) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:JfZh8lcE+oAKSM6xzXuO665KmYCgUtrmv45QJh33rOeUZg==");
...
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:/v9HKEi1R2qw4TZfebszhHPQSLgOnzoMfhRI9Q==");
...
// Start of branch "customer_dim"
						if (customer_dim != null) {
							...
							if (execStat) {
								runStat.updateStatOnConnection(iterateId, 1, 1, "customer_dim");
							}
							...
							if (customer_dim.CUSTOMER_COUNTRY == null) {
								...
								pstmt_tDBOutput_1.setString(2, customer_dim.CUSTOMER_COUNTRY);
							}

							if (customer_dim.CUSTOMER_GROUP == null) {
								pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(3, customer_dim.CUSTOMER_GROUP);
							}

							if (customer_dim.CUSTOMER_TYPE == null) {
								pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(4, customer_dim.CUSTOMER_TYPE);
							}
							...
							if (customer_dim.CUSTOMER_GENDER == null) {
								...
								if (customer_dim.CUSTOMER_GENDER == null) {
									...
									pstmt_tDBOutput_1.setString(5, String.valueOf(customer_dim.CUSTOMER_GENDER));
								}
							}
							...
							if (customer_dim.CUSTOMER_AGE_GROUP == null) {
								...
								pstmt_tDBOutput_1.setString(6, customer_dim.CUSTOMER_AGE_GROUP);
							}

							if (customer_dim.CUSTOMER_AGE == null) {
								pstmt_tDBOutput_1.setNull(7, java.sql.Types.DOUBLE);
							} else {
								pstmt_tDBOutput_1.setDouble(7, customer_dim.CUSTOMER_AGE);
							}

							if (customer_dim.CUSTOMER_NAME == null) {
								pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(8, customer_dim.CUSTOMER_NAME);
							}

							if (customer_dim.CUSTOMER_FIRSTNAME == null) {
								pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(9, customer_dim.CUSTOMER_FIRSTNAME);
							}

							if (customer_dim.CUSTOMER_LASTNAME == null) {
								pstmt_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(10, customer_dim.CUSTOMER_LASTNAME);
							}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:bSJKnK14JlDRkhK7CqxFHtQv+VzharPSsFKvUw==");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Job01_Customer_Dim.class.getClassLoader()
					.getResourceAsStream("orion/job01_customer_dim_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 94726 characters generated by Talend Open Studio for Data Integration on the
 * January 23, 2021 at 11:35:34 PM CET
 ************************************************************************************************/