...
public class TAccessInputBeginJava
{
  ...
  protected final String TEXT_131 = " = \"jdbc:ucanaccess://\" + ";
  protected final String TEXT_132 = " + \";jackcessOpener=org.talend.ucanaccess.encrypt.CryptCodecOpener;singleConnection=true\";";
  protected final String TEXT_133 = NL + "\t\t\tString driverClass_";
  protected final String TEXT_134 = "\";" + NL + "\t\t\tjava.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_139 = NL + "\t\t   \t" + NL + "\t        String dbPwd_";
  protected final String TEXT_140 = ";" + NL + "\t        ";
  protected final String TEXT_141 = NL + "\t\t\tconn_";
  protected final String TEXT_142 = NL + "\t\t\tString atnParams_";
  protected final String TEXT_143 = ";" + NL + "\t\t\tatnParams_";
  protected final String TEXT_144 = " = atnParams_";
  ...
  protected final String TEXT_150 = ".load(new java.io.ByteArrayInputStream(atnParams_";
  protected final String TEXT_151 = ".getBytes()));" + NL + "\t\t\tconn_";
  protected final String TEXT_152 = ", atnParamsPrope_";
  protected final String TEXT_153 = NL + "            java.sql.Timestamp timestamp_";
  protected final String TEXT_154 = ".getTimestamp(";
  protected final String TEXT_155 = ");" + NL + "            if(timestamp_";
  protected final String TEXT_156 = " != null) {";
  protected final String TEXT_157 = NL + "                ";
  protected final String TEXT_158 = " = new java.util.Date(timestamp_";
  protected final String TEXT_159 = ".getTime());" + NL + "            } else {";
  ...
  protected final String TEXT_163 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_164 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_165 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_166 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_167 = " =  conn_";
  protected final String TEXT_168 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_169 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_170 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_171 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_172 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_173 = NL + "                 conn_";
  protected final String TEXT_174 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_175 = NL + "               ";
  protected final String TEXT_176 = " + \"=\" + ";
  protected final String TEXT_177 = " + \";\" +";
  protected final String TEXT_178 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_179 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_180 = NL + "\t\t    ";
  protected final String TEXT_181 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_182 = ";" + NL + "\t\t\t";
  protected final String TEXT_183 = NL + "                log.debug(\"";
  protected final String TEXT_184 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_185 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_186 = NL;
  protected final String TEXT_187 = NL + "            \tglobalMap.put(\"";
  protected final String TEXT_188 = "_QUERY\",dbquery_";
  protected final String TEXT_189 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_190 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  protected final String TEXT_191 = " = stmt_";
  protected final String TEXT_192 = ".executeQuery(dbquery_";
  protected final String TEXT_193 = ");" + NL + "\t\t    \tjava.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_194 = ".getMetaData();" + NL + "\t\t    \tint colQtyInRs_";
  protected final String TEXT_195 = " = rsmd_";
  protected final String TEXT_196 = ".getColumnCount();" + NL;
  protected final String TEXT_197 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_198 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_199 = ".setDbmsId(\"";
  protected final String TEXT_200 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_201 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_202 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_203 = ".add(\"";
  protected final String TEXT_204 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_205 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_206 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_207 = "; i <= rsmd_";
  protected final String TEXT_208 = ".getColumnCount()-";
  protected final String TEXT_209 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_210 = ".contains(rsmd_";
  protected final String TEXT_211 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_212 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_213 = ".setName(rsmd_";
  protected final String TEXT_214 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_215 = ".setDbName(rsmd_";
  protected final String TEXT_216 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_217 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_218 = "\", rsmd_";
  protected final String TEXT_219 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_220 = ".getPrecision(i), rsmd_";
  protected final String TEXT_221 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_222 = ".setDbType(rsmd_";
  protected final String TEXT_223 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_224 = ".setDbTypeId(rsmd_";
  protected final String TEXT_225 = ".getColumnType(i));";
  protected final String TEXT_226 = NL + "                \tdcm_";
  protected final String TEXT_227 = ".setFormat(";
  protected final String TEXT_228 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_229 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_230 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_231 = ".setLength(rsmd_";
  protected final String TEXT_232 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_233 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_234 = NL + "\t\t\tdcm_";
  protected final String TEXT_235 = ".getPrecision(i));";
  protected final String TEXT_236 = ".setPrecision(rsmd_";
  protected final String TEXT_237 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_238 = ".setNullable(rsmd_";
  protected final String TEXT_239 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_240 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_241 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_242 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_243 = ".metadatas.add(dcm_";
  protected final String TEXT_244 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_245 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_246 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_247 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_248 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_249 = NL + "\t\t    \tlog.debug(\"";
  protected final String TEXT_250 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_251 = NL + "\t\t    while (rs_";
  protected final String TEXT_252 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_253 = "++;" + NL + "\t\t        ";
  protected final String TEXT_254 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_255 = " + dcg_";
  protected final String TEXT_256 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_257 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_258 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_259 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  ...
  protected final String TEXT_266 = " = (List)rs_";
  protected final String TEXT_267 = ".getObject(";
  protected final String TEXT_268 = NL + "\t                         \t\t";
  protected final String TEXT_269 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_270 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_271 = NL + "                                    ";
  protected final String TEXT_272 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  protected final String TEXT_273 = NL + "                                      ";
  protected final String TEXT_274 = " = null;" + NL + "                                    }";
  protected final String TEXT_275 = NL + "                                        if (";
  protected final String TEXT_276 = NL + "                                        ";
  protected final String TEXT_277 = ".setEPSG(";
  protected final String TEXT_278 = ");" + NL + "                                        }";
  protected final String TEXT_279 = NL + "                                  ";
  protected final String TEXT_280 = "=dcg_";
  protected final String TEXT_281 = ";";
  protected final String TEXT_282 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_283 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_284 = "; i_";
  protected final String TEXT_285 = "  <= rsmd_";
  protected final String TEXT_286 = ".getColumnCount(); i_";
  protected final String TEXT_287 = " ++){" + NL + "\t\t\t\t\t    \t\t\t\t\t";
  protected final String TEXT_288 = NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_289 = ".getColumnTypeName(i_";
  protected final String TEXT_290 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_291 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_292 = ".getClob(i_";
  protected final String TEXT_293 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_294 = " !=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_295 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_296 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_297 = ".add(tNTextImpl_";
  protected final String TEXT_298 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_299 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_300 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_301 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_302 = ".add(rs_";
  protected final String TEXT_303 = ".getString(i_";
  protected final String TEXT_304 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_305 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_306 = ", rs_";
  protected final String TEXT_307 = ", fixedColumnCount_";
  protected final String TEXT_308 = ",list_";
  protected final String TEXT_309 = ",";
  protected final String TEXT_310 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_311 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_312 = NL + "                                  Object geom = rs_";
  protected final String TEXT_313 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_314 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  protected final String TEXT_315 = " = null;" + NL + "                                  }";
  protected final String TEXT_316 = NL + "\t\t                          ";
  protected final String TEXT_317 = NL + "\t\t                    }";
  protected final String TEXT_318 = NL + "\t\t\t\t\t";
  protected final String TEXT_319 = " - Retrieving the record \" + nb_line_";
