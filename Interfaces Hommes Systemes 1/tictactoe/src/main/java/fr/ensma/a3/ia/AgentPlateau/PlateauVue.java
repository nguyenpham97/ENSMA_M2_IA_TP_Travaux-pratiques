...
public class PlateauVue extends TilePane //implements EventHandler<ActionEvent>//, IPlateauPresentation
{
	...
	public PlateauVue(final PlateauPresentation p) {
		...
		this.setHgap(10);
		this.setVgap(10);
		System.out.println("Done before Case");
		AgentCase = new CasePresentation(this.getPresentation());
		System.out.println("Done after Case");
