 ...
 *******************************************************************************/
package fr.ensma.idm.robotdsl.nxcgenerator.main;
...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/fr/ensma/idm/robotdsl/nxcgenerator/main/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(robotnxt.RobotnxtPackage.class)) {
            resourceSet.getPackageRegistry().put(robotnxt.RobotnxtPackage.eINSTANCE.getNsURI(), robotnxt.RobotnxtPackage.eINSTANCE);
        }
